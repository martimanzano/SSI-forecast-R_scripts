...
autocorrelationTest <- function(tsObject, plotMain = "Autocorrelation plot") { # ALTERNATIVE: https://rdrr.io/cran/hwwntest/man/hwwn.test.html
  ...
  print(sprintf("Percentage of spikes outside bounds: %.2f%%", (spikesOutsideBounds/length(tsObject))*100))
  print(ggAcf(tsObject, main = plotMain))
  print("Autocorrelation test result:")
